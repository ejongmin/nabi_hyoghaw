...
PATH_EDGES_INT = ROOT / "experiments/universe_44/data/seed/seed_edges_44.csv"
PATH_C18       = ROOT / "experiments/universe_44/data/universe/companies_44.csv"

OUT_PANEL      = ROOT / "data/processed/car_panel_phase4_44.parquet"
OUT_CAAR       = ROOT / "reports/phase4_caar_44.csv"
OUT_HETERO     = ROOT / "reports/phase4_hetero_44.csv"
OUT_CONTAGION  = ROOT / "reports/phase4_contagion_44.csv"
OUT_REPORT     = ROOT / "reports/phase4_summary_44.txt"
...
def load_internal_edges() -> pd.DataFrame:
    """experiments/universe_44/data/seed/seed_edges_44.csv 로드 및 검증"""
